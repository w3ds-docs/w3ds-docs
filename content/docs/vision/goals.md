...
These goals define the fundamental direction and invariants of the system.  

They are not implementation requirements, but constraints used to evaluate all design and architectural decisions.

These goals apply to all entities in the system, including individuals, groups, organizations and services.
