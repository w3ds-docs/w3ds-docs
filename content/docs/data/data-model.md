...
- **Record authorship** is held by the eVault holding the record. The manufacturer's record about the car is the manufacturer's, written under its sovereignty; the owner's record about the same car is the owner's, written under hers; the service center's record is the service center's; the government registry's record is the government's. Each eVault decides who may write to its own records, including delegated co-control where the holder grants another actor write access. Access rules are a future page.
